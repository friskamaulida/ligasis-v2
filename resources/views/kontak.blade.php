        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-12 mx-auto">
                <form class="custom-form contact-form" action="{{ route('contact.store') }}" method="POST" role="form">
                    ...
                    <p class="mb-4">
                        Kirim pesan langsung atau melalui email:
                    ...
                    <textarea name="message" rows="5" class="form-control" id="message" placeholder="Apa yang bisa kami bantu?" required></textarea>
